...
mysql-procs.pl - mysql show full processlist
...
my ($user, $pass) = qw( ottadmin lutralutra ); # ottro cannot see all processes, ottadmin can
...
sub show_databases {
    my @db = qw( vm-mii-otlp:3324 mcs17:3322 mcs17:3323 );
...
#    push @db, qw(  otterslave:3312 otterslave:3313 ); # old slaves - dead hardware
    push @db, qw(  mcs18:3322  mcs18:3323  mcs18:3324 ); # new slaves
