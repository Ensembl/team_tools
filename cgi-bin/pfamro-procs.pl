...
pfamro-procs.pl - mysql show full processlist
...
my ($user, $pass) = (pfamro => undef); # cannot see all processes
...
<head>
 <title>pfamro-procs (Anacode)</title>
 <style type="text/css">
@{[ css_text() ]}
 </style>
